...
var convertors = {
    ...
    br: function (state, node) {
        ...
        if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === 'paragraph') {
            ...
            if (node.prev && (isInlineNode$1(node.prev) || isCustomHTMLInlineNode(state, node.prev))) {
                state.closeNode();
            }
            if (node.next && (isInlineNode$1(node.next) || isCustomHTMLInlineNode(state, node.next))) {
                state.openNode(paragraph);
            }
        }
    },
