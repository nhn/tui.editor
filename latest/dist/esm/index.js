...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype.addImage = function () {
        return function (payload) { return function (_a, dispatch) {
            ...
            var node = schema.nodes.image.createAndFill(__assign$1({ imageUrl: escapeXml$1(imageUrl) }, (altText && { altText: altText })));
...
var toMdConvertors = {
    ...
    image: function (_a) {
        ...
        var imageUrl = escapeXml$1(attrs.imageUrl);
    ...
    link: function (_a, _b) {
        ...
        var entering = _b.entering;
        var attrs = node.attrs;
        var linkUrl = escapeXml$1(attrs.linkUrl);
