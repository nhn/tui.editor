import {
    ...
    _parseTd,
    _generateTableObjectFrom$Table,
    _divideTrs,
    _mergeByColspan,
...
describe('mergedTableCreator', () => {
    ...
    describe('_generateTableObjectFrom$Table()', () => {
        it('Generate json from jQuery table.', () => {
            const tableHtml = [
                '<table>',
                '<thead>',
            ...
            const actual = _generateTableObjectFrom$Table($table);
