...
describe('PopupAddTable', () => {
  ...
  describe('cell bound caculation', () => {
    ...
    it('2 x 2 offset to bound', () => {
      const bound = popup._getBoundByOffset((PopupAddTable.CELL_WIDTH * 2) + 10,
    ...
    it('4 x 3 offset to bound', () => {
      const bound = popup._getBoundByOffset((PopupAddTable.CELL_WIDTH * 3) + 10,
  ...
  describe('_getSelectionBoundByOffset', () => {
    it('get selection bound by offset', () => {
      const bound = popup._getSelectionBoundByOffset(PopupAddTable.CELL_WIDTH * 4, PopupAddTable.CELL_HEIGHT * 5);
