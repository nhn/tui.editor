  ...
  describe('image', () => {
    describe('ie', () => {
      ...
      it('should not call hook on multiple items in paste data', done => {
        const ev = createWWIEImageClipboardEvent([document.createElement('img'), document.createElement('img')]);
        spyOn(ev.data, 'preventDefault');
