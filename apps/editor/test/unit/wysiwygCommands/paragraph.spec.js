...
describe('Paragraph', () => {
  ...
  it('set paragraph tag', () => {
    ...
    expect(matched(wwe.getBody().childNodes[0], 'DIV')).toBe(true);
  ...
  it('set paragraph tag', () => {
    ...
    expect(wwe.getBody().childNodes[2].textContent).toBe('listitem1');
  ...
  it('set paragraph tag', () => {
    ...
    expect(matched(wwe.getBody().childNodes[0], 'UL')).toBe(true);
    expect(matched(wwe.getBody().childNodes[1], 'DIV')).toBe(true);
    expect(wwe.getBody().childNodes[1].textContent).toBe('listitem2');
    expect(wwe.getBody().querySelectorAll('div').length).toBe(4);
    expect(wwe.getBody().querySelectorAll('ul').length).toBe(1);
    expect(wwe.getBody().querySelectorAll('li').length).toBe(1);
  });
  ...
  it('set paragraph tag', () => {
    ...
    expect(matched(wwe.getBody().childNodes[0], 'TABLE')).toBe(true);
    expect(matched(wwe.getBody().childNodes[1], 'DIV')).toBe(true);
    expect(wwe.getBody().childNodes[1].textContent).toBe('listitem1');
    expect(matched(wwe.getBody().childNodes[2], 'DIV')).toBe(true);
    expect(wwe.getBody().childNodes[2].textContent).toBe('listitem2');
