...
class PopupCodeBlockEditor extends LayerPopup {
  ...
  _initEditorEvent() {
    ...
    this.eventEmitter.listen('openPopupCodeBlockEditor', codeBlockElement => {
      this.eventEmitter.emit('closeAllPopup');
      this.show(codeBlockElement);

      return this;
    });
    this.eventEmitter.listen('closeAllPopup', this.hide.bind(this));
    this.eventEmitter.listen('closePopupCodeBlockEditor', this.hide.bind(this));
  }
  ...
  _createCodeBlockEditor() {
    ...
    this._codeBlockEditor = new CodeBlockEditor(codeMirrorWrapper, this.eventEmitter);
  ...
  _createCodeBlockLanguagesCombo() {
    ...
    const codeBlockLanguagesCombo = new CodeBlockLanguagesCombo(this.eventEmitter, this.languages);
