...
class PopupAddLink extends LayerPopup {
  ...
  _initInstance(options) {
    ...
    this._eventEmitter = options.editor.eventEmitter;
  }
  ...
  _initEditorEvent() {
    ...
    eventEmitter.listen('focus', () => this.hide());
    eventEmitter.listen('closeAllPopup', () => this.hide());
    eventEmitter.listen('openPopupAddLink', () => {
