 ...
 */
class BlockOverlay {
  constructor({ eventEmitter, container, attachedSelector }) {
  ...
  _initEvent() {
    this._eventEmitter.listen('change', this._onChange.bind(this));
    this._eventEmitter.listen('mouseover', this._onMouseOver.bind(this));
    this._eventEmitter.listen('focus', () => {
      this.setVisibility(false);
    });
    this._eventEmitter.listen('mousedown', () => {
      this.setVisibility(false);
    });
  }
