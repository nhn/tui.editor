...
class CodeBlockGadget extends BlockOverlay {
  ...
  _initDOM() {
    ...
    this._eventEmitter.emit('removeEditor', () => {
  ...
  _openPopupCodeBlockEditor() {
    this._eventEmitter.emit('openPopupCodeBlockEditor', this.getAttachedElement());
  }
  ...
  onShow() {
    ...
    this._eventEmitter.listen('changeLanguage', this._onAttachedElementChange);
   ...
   */
  onHide() {
    this._eventEmitter.removeEventHandler('changeLanguage', this._onAttachedElementChange);
