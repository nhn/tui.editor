...
class UIController {
  ...
  constructor(options = {}) {
    ...
    this.customEventEmitter = new CustomEvents();
  ...
  _addEvent(type, fn) {
    ...
    if (inArray(event, DOM_EVENTS) > -1) {
      ...
      this.customEventEmitter.on(event, fn);
    }
  }
  ...
  off(type, fn) {
    ...
    if (inArray(event, DOM_EVENTS) > -1) {
      ...
      this.customEventEmitter.off(event, fn);
    }
  }
  ...
  trigger(eventName, eventData) {
    this.customEventEmitter.fire(eventName, eventData);
  }
