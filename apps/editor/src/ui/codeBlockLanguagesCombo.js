 ...
 */
class CodeBlockLanguagesCombo {
  constructor(eventEmitter, languages) {
  ...
  _initEvent() {
    this._eventEmitter.listen('setCodeBlockLanguages', languages => {
      this._languages = languages;
  ...
  _showPopupCodeBlockLanguages() {
    ...
    this._popupCodeBlockLanguages = this._eventEmitter.emitReduce('openPopupCodeBlockLanguages', {
  ...
  _hidePopupCodeBlockLanguages() {
    this._eventEmitter.emit('closePopupCodeBlockLanguages');
  }
