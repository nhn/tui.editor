...
class PopupCodeBlockLanguages extends LayerPopup {
  ...
  _initEditorEvent() {
    ...
    this.eventEmitter.listen('openPopupCodeBlockLanguages', data => {
    ...
    this.eventEmitter.listen('closePopupCodeBlockLanguages', () => this.hide());
    this.eventEmitter.listen('scroll', () => this.hide());
    this.eventEmitter.listen('setCodeBlockLanguages', languages =>
