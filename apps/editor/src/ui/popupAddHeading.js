...
class PopupAddHeading extends LayerPopup {
  ...
  _initEditorEvent() {
    ...
    this._eventEmitter.listen('focus', this.hide.bind(this));
    this._eventEmitter.listen('closeAllPopup', this.hide.bind(this));
    this._eventEmitter.listen('openHeadingSelect', () => {
