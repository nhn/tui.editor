...
declare class ToolbarItem extends UIController {
...
declare class Button extends ToolbarItem {
  public static className: string;
  public static name: string;
...
declare class Toolbar extends UIController {
...
declare class DefaultToolbar extends Toolbar {}
