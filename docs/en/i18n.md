...
Use the `setLanguage` static method to override the value for a specific language code. See [here](https://github.com/nhn/tui.editor/tree/main/apps/editor/src/i18n/en-us.ts) for default values.
...
Refer to [this file](https://github.com/nhn/tui.editor/tree/main/src/i18n/en-us.ts) and write each parameter value used when calling the `setLanguage` method.
